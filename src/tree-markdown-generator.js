...
function getMarkdownLinesForTree(tree, parentPathParts, environment) {
  ...
  for (const treeNode of tree) {
    ...
    if (treeNode.isDirectory) {
      ...
      const linesForChildren = getMarkdownLinesForTree(treeNode.children, fullPathParts, environment);
...
function getMarkdownForTreeNode(treeNode, parentPath, environment) {
  ...
  const markdownForLink = markdownParser.generateLinkFromMarkdownParagraphAndUrl(linkParagraphText, linkTarget);
